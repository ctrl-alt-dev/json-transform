 ...
 */
package nl.ctrlaltdev.json.transform.transforms.convert.time;
...
public class FormatTimestampToLocalDateTimeConversion implements ValuePathTransform {

    private DateTimeFormatter formatter;

    public FormatTimestampToLocalDateTimeConversion() {
        this(DateTimeFormatter.ISO_DATE_TIME);
    }

    public FormatTimestampToLocalDateTimeConversion(String format) {
        this(DateTimeFormatter.ofPattern(format));
    }

    public FormatTimestampToLocalDateTimeConversion(DateTimeFormatter formatter) {
