...
import static nl.ctrlaltdev.json.transform.mapping.builder.CompositeMappingBuilder.join;
import static nl.ctrlaltdev.json.transform.mapping.builder.CompositeMappingBuilder.parallel;
import static nl.ctrlaltdev.json.transform.mapping.builder.CompositeMappingBuilder.sequence;
import static nl.ctrlaltdev.json.transform.mapping.builder.CompositeMappingBuilder.split;
import static nl.ctrlaltdev.json.transform.mapping.builder.MappingBuilder.copy;
import static nl.ctrlaltdev.json.transform.mapping.builder.MappingBuilder.javaTransform;
import static nl.ctrlaltdev.json.transform.mapping.builder.MappingBuilder.manyToMany;
import static nl.ctrlaltdev.json.transform.mapping.builder.MappingBuilder.map;
import static nl.ctrlaltdev.json.transform.mapping.builder.MappingBuilder.move;
import static nl.ctrlaltdev.json.transform.mapping.builder.MappingBuilder.template;
import static nl.ctrlaltdev.json.transform.mapping.builder.MappingBuilder.transform;
...
import nl.ctrlaltdev.json.transform.java.PojoToDocumentMapperTest;
import nl.ctrlaltdev.json.transform.mapping.source.DocumentSource;
import nl.ctrlaltdev.json.transform.mapping.source.JavaSource;
import nl.ctrlaltdev.json.transform.mapping.source.MultiSource;
import nl.ctrlaltdev.json.transform.mapping.source.SplitSource;
...
import nl.ctrlaltdev.json.transform.template.CallbackTemplate;
import nl.ctrlaltdev.json.transform.template.handler.SelectHandler;
import nl.ctrlaltdev.json.transform.transforms.FlattenCompositeTransform;
