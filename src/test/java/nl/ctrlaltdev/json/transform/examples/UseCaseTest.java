 ...
 */
package nl.ctrlaltdev.json.transform.examples;

import static nl.ctrlaltdev.json.transform.JsonTransform.join;
import static nl.ctrlaltdev.json.transform.JsonTransform.jsonPath;
import static nl.ctrlaltdev.json.transform.JsonTransform.mapProperties;
import static nl.ctrlaltdev.json.transform.JsonTransform.multiSource;
import static nl.ctrlaltdev.json.transform.JsonTransform.parallel;
import static nl.ctrlaltdev.json.transform.JsonTransform.path;
import static nl.ctrlaltdev.json.transform.JsonTransform.select;
import static nl.ctrlaltdev.json.transform.JsonTransform.sequence;
import static nl.ctrlaltdev.json.transform.mapping.builder.MappingBuilder.copy;
import static nl.ctrlaltdev.json.transform.mapping.builder.MappingBuilder.exists;
